...
export const metadata: Metadata = {
  title: 'Tailor in Kensington, London | Home Visits | Fine Tailors',
  description: 'Fine Tailors visits your home in Kensington, London. Expert suit & dress alterations at your door. 10+ years experience. Book your Kensington home visit today.',
  alternates: { canonical: 'https://www.finetailors.co.uk/tailor-kensington' },
  openGraph: {
    title: 'Tailor in Kensington, London | Fine Tailors',
      ...
      <main className="pt-[57px] lg:pt-[65px] bg-parchment min-h-screen">
        ...
        <div className="px-8 lg:px-24 py-20 border-b border-divider">
          ...
          <p className="font-sans font-light text-lg text-muted max-w-2xl leading-relaxed">
            Fine Tailors covers all W8 and surrounding Kensington postcodes, bringing expert tailoring and clothing alterations at home to your door. Professional, discreet, precise.
          </p>
        </div>
        ...
        <div className="px-8 lg:px-24 py-16 border-b border-divider max-w-4xl">
          ...
          <p className="font-sans font-light text-muted leading-relaxed mb-4">
            Kensington is one of London&apos;s most sought-after postcodes, home to garden squares, stucco-fronted townhouses, and residents who value their time. As your Kensington tailor, Fine Tailors provides a seamless service that respects your schedule and your wardrobe.
          </p>
          <p className="font-sans font-light text-muted leading-relaxed mb-4">
