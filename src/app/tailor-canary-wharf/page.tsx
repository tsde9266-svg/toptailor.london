...
export const metadata: Metadata = {
  title: 'Tailor in Canary Wharf London | Collection Service | Fine Tailors',
  description: 'Collection-based tailor in Canary Wharf. We collect from your E14 door, alter suits for finance professionals, and return pressed and perfect in 5–7 days.',
  alternates: { canonical: 'https://www.finetailors.co.uk/tailor-canary-wharf' },
  openGraph: {
    title: 'Tailor in Canary Wharf London | Collection Service | Fine Tailors',
    url: 'https://www.finetailors.co.uk/tailor-canary-wharf',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'Collection-based tailoring service in Canary Wharf, London' }],
  },
}
...
const localBusiness = {
  ...
  priceRange: '££',
  areaServed: { '@type': 'Neighborhood', name: 'Canary Wharf' },
...
export default function TailorCanaryWharf() {
  return (
    <>
      <Script id="schema-breadcrumb-canary" type="application/ld+json" strategy="afterInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Script id="schema-business-canary" type="application/ld+json" strategy="afterInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(localBusiness) }} />
      <Script id="schema-faq-canary" type="application/ld+json" strategy="afterInteractive"
