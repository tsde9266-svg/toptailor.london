...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'Collection-based tailoring service in Pimlico, London' }],
  },
}
...
export default function TailorPimlico() {
  return (
    <>
      <Script id="schema-breadcrumb-pimlico" type="application/ld+json" strategy="afterInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
      <Script id="schema-business-pimlico" type="application/ld+json" strategy="afterInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(localBusiness) }} />
      <Script id="schema-faq-pimlico" type="application/ld+json" strategy="afterInteractive"
