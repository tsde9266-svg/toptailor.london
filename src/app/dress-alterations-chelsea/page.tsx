...
export const metadata: Metadata = {
  title: 'Dress Alterations Chelsea | Collected From Your Home | Fine Tailors',
  description: 'Expert dress alterations in Chelsea — collected from your SW3/SW10 home and returned perfectly fitted in 5–7 working days. Fine Tailors covers all of Central London.',
  alternates: { canonical: 'https://www.finetailors.co.uk/dress-alterations-chelsea' },
  keywords: [
    'dress alterations Chelsea',
    'dress alterations near me Chelsea',
    'dress alterations Chelsea London',
    'tailor Chelsea London',
    'alterations Chelsea',
    'Chelsea dress alterations',
  ],
  openGraph: {
    title: 'Dress Alterations Chelsea | Home Collection | Fine Tailors',
    description: 'Expert dress alterations in Chelsea, collected from your SW3/SW10 door. Returned perfectly fitted in 5–7 working days.',
    url: 'https://www.finetailors.co.uk/dress-alterations-chelsea',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Dress Alterations Chelsea London' }],
  },
}
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Dress Alterations Chelsea', item: 'https://www.finetailors.co.uk/dress-alterations-chelsea' },
  ],
}
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Dress Alterations Chelsea',
  provider: {
    '@type': 'LocalBusiness',
  ...
  description: 'Professional dress alterations in Chelsea, London. Home collection and return service. Garments fully insured while in transit.',
  serviceType: 'Dress Alterations',
}

export default function DressAlterationsChelsea() {
  return (
    <>
      ...
      <main className="pt-[57px] lg:pt-[65px] bg-parchment min-h-screen">
        ...
        <div className="px-8 lg:px-24 py-20 border-b border-divider">
          ...
          <h1 className="font-playfair text-[2.5rem] lg:text-[3.5rem] leading-[1.1] font-medium text-charcoal mb-6">
            Dress Alterations in Chelsea —{' '}
            <em className="font-playfair italic">Collected From Your Door</em>
          </h1>
          <p className="font-sans font-light text-lg text-muted max-w-2xl leading-relaxed">
            Fine Tailors provides expert <strong>dress alterations in Chelsea</strong> with a full home collection and return service. Chelsea has a long history of fashion-consciousness — from the boutiques of the King&apos;s Road to the evening wear that goes to Hurlingham and beyond. Fine Tailors collects dresses from Chelsea addresses and returns them perfectly altered, with no need to carry valuable or delicate garments across the city.
          </p>
        ...
        <div className="px-8 lg:px-24 py-16 border-b border-divider max-w-4xl">
          ...
          <p className="font-sans font-light text-muted leading-relaxed mb-4">
            The traditional route for dress alterations is to carry your garments to a shop, leave them, and return to collect. In Chelsea, that means transporting valuable pieces across London unnecessarily. Fine Tailors removes every step.
          </p>
          <p className="font-sans font-light text-muted leading-relaxed mb-4">
        ...
        <div className="px-8 lg:px-24 py-16 border-b border-divider max-w-4xl">
          ...
          <ul className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <li className="font-sans font-light text-sm text-muted border border-divider px-4 py-3">Draycott Avenue</li>
