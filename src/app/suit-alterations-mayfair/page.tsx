...
export const metadata: Metadata = {
  title: 'Suit Alterations Mayfair | Collected From Your Home | Fine Tailors',
  description: 'Expert suit alterations in Mayfair — collected from your W1J/W1K home and returned perfectly fitted in 5–7 working days. Fine Tailors covers all of Central London.',
  alternates: { canonical: 'https://www.finetailors.co.uk/suit-alterations-mayfair' },
  keywords: [
    'suit alterations Mayfair',
    'suit alterations near me Mayfair',
    'suit alterations Mayfair London',
    'tailor Mayfair London',
    'alterations Mayfair',
    'Mayfair suit alterations',
  ],
  openGraph: {
    title: 'Suit Alterations Mayfair | Home Collection | Fine Tailors',
    description: 'Expert suit alterations in Mayfair, collected from your W1J/W1K door. Returned perfectly fitted in 5–7 working days.',
    url: 'https://www.finetailors.co.uk/suit-alterations-mayfair',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Suit Alterations Mayfair London' }],
  },
}
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Suit Alterations Mayfair', item: 'https://www.finetailors.co.uk/suit-alterations-mayfair' },
  ],
}
...
const serviceSchema = {
  ...
  description: 'Professional suit alterations in Mayfair, London. Home collection and return service. Garments fully insured while in transit.',
  serviceType: 'Suit Alterations',
}

export default function SuitAlterationsMayfair() {
  return (
    <>
      ...
      <main className="pt-[57px] lg:pt-[65px] bg-parchment min-h-screen">
        ...
        <div className="px-8 lg:px-24 py-16 border-b border-divider max-w-4xl">
          ...
          <p className="font-sans font-light text-muted leading-relaxed mb-4">
            The traditional route for suit alterations is to carry your garments to a shop, leave them, and return to collect. In Mayfair, that means transporting valuable pieces across London unnecessarily. Fine Tailors removes every step.
          </p>
          <p className="font-sans font-light text-muted leading-relaxed mb-4">
