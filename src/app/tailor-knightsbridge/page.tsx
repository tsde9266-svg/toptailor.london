...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.oneclicktailors.co.uk/tailor-knightsbridge' },
  openGraph: {
    title: 'Tailor in Knightsbridge, London | One Click Tailor',
    url: 'https://www.oneclicktailors.co.uk/tailor-knightsbridge',
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Tailor in Knightsbridge', item: 'https://www.oneclicktailors.co.uk/tailor-knightsbridge' },
  ],
}
