...
export const metadata: Metadata = {
  title: 'Tailor in Knightsbridge, London | Home Visits | Fine Tailors',
  description: 'Fine Tailors visits your home in Knightsbridge, London. Expert suit & dress alterations at your door. 10+ years experience. Book your Knightsbridge home visit today.',
  alternates: { canonical: 'https://www.finetailors.co.uk/tailor-knightsbridge' },
  openGraph: {
    title: 'Tailor in Knightsbridge, London | Fine Tailors',
      ...
      <main className="pt-[57px] lg:pt-[65px] bg-parchment min-h-screen">
        ...
        <div className="px-8 lg:px-24 py-20 border-b border-divider">
          ...
          <p className="font-sans font-light text-lg text-muted max-w-2xl leading-relaxed">
            Steps from Harrods and Harvey Nichols, Fine Tailors offers premium clothing alterations at home across Knightsbridge. We visit your door — so your garments never have to travel alone.
          </p>
        </div>
