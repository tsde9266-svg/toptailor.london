...
export const metadata: Metadata = {
  title: 'Page Not Found — Fine Tailors',
  description:
    "The page you're looking for doesn't exist. Return to Fine Tailors for expert tailoring and alterations in central London.",
  robots: {
    index: false,
    follow: false,
  },
